...
// React Bits "Strands", ported to TypeScript: glowing woven light-trails
// rendered with ogl. Used as a subtle decorative backdrop — see
// FlightPaths.tsx for how it's deferred and themed for this site.
...
export default function Strands({
  ...
  const propsRef = useRef<Required<Omit<Props, "className" | "style">>>({
    colors,
    count,
    speed,
    amplitude,

...
function DestinationCard({ d }: { d: Destination }) {
  return (
    <Link href={`/destinations/${d.slug}/`} className="group block h-full" draggable={false}>
  ...
  return (
    <section className="relative bg-surface py-24">
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        ...
        {/* Mobile: swipe the deck, tap to open */}
        <div className="mt-14 sm:hidden">
          <Reveal>
            <SwipeStack autoAdvance={6000}>
              {destinations.map((d) => (

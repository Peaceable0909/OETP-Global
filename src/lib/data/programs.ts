...
const FALLBACK_PROGRAMS_RAW: {
  ...
  { slug: "thailand-partner-institutions-international-trade-management", universitySlug: "shinawatra-university", name: "International Trade Management", overview: "BBA specialization in cross-border trade and international business (Faculty of Management)", entryRequirements: ["Secondary school certificate", "Valid international passport", "Basic English proficiency"], requiredDocuments: ["International passport", "Academic certificates", "Passport photograph"] },
  { slug: "thailand-partner-institutions-logistics-and-supply-chain-management", universitySlug: "shinawatra-university", name: "Logistics and Supply Chain Management", overview: "BBA specialization in logistics and supply chain (Faculty of Management)", entryRequirements: ["Secondary school certificate", "Valid international passport", "Basic English proficiency"], requiredDocuments: ["International passport", "Academic certificates", "Passport photograph"] },
  { slug: "thailand-partner-institutions-business-chinese", universitySlug: "shinawatra-university", name: "Business Chinese", overview: "BBA specialization combining business with Chinese-language proficiency (Faculty of Management)", entryRequirements: ["Secondary school certificate", "Valid international passport", "Basic English proficiency"], requiredDocuments: ["International passport", "Academic certificates", "Passport photograph"] },
  { slug: "thailand-partner-institutions-business-administration", universitySlug: "shinawatra-university", name: "Business Administration", overview: "Master & Doctoral study in business and political administration (Faculty of Management)", entryRequirements: ["Secondary school certificate", "Valid international passport", "Basic English proficiency"], requiredDocuments: ["International passport", "Academic certificates", "Passport photograph"] },
  { slug: "thailand-partner-institutions-psychology", universitySlug: "shinawatra-university", name: "Psychology", overview: "Master & Doctoral psychological sciences and research (Faculty of Psychology)", entryRequirements: ["Secondary school certificate", "Valid international passport", "Basic English proficiency"], requiredDocuments: ["International passport", "Academic certificates", "Passport photograph"] },

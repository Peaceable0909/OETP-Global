...
const channels = [
  { icon: "💬", title: "WhatsApp", desc: "Fastest replies — talk to a counselor directly.", href: site.whatsapp, cta: "Open WhatsApp", color: "bg-green-500" },
  { icon: "✈️", title: "Telegram", desc: "Our assistant collects your details and answers instantly.", href: site.telegram, cta: "Open Telegram", color: "bg-sky-500" },
  { icon: "📧", title: "Email", desc: "For documents and formal enquiries.", href: `mailto:${site.email}`, cta: "Send Email", color: "bg-brand-600" },
];
      ...
      <div className="mt-14 grid gap-6 md:grid-cols-3">
        {channels.map((c, i) => (
          <Reveal key={c.title} delay={i * 80} className="h-full">
            ...
            >
              <span className={`grid h-14 w-14 place-items-center rounded-2xl text-2xl text-white ${c.color}`}>{c.icon}</span>
